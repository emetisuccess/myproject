                ...
                <div class="widget widget_search">
                    ...
                    <form role="search" method="get" class="search-form" action="http://webdesign-finder.com/">
                        ...
                        <input type="search" id="search-form-widget" class="search-field"
                            placeholder=" Input Your Tracking Number" style="padding-left: 5px;" value="" name="search">
...
<section class="s-pt-60 s-pb-15 s-py-lg-90 ms w-100 mx-auto mt-5"
            ...
            <div class="col-md-6 col-lg-4">
                <div class="d-flex flex-column  contact-icon">
                    ...
                    <div class=" text-center mt-3 p-2">
                        ...
                        <p>Different sized vehicles based on your order size and delivery location for excellent courier
                            service.
                        </p>
                    </div>
                </div>
