...
<section class="page_title ds s-pt-105 s-pb-50 s-pt-lg-115 s-pb-lg-60">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12">
                <h1 class="bold text-center text-lg-left">Signup for an Account</h1>
                <ol class="breadcrumb">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group has-placeholder">
                                    ...
                                    <input type="password" aria-required="true" size="30" value="" name="confirmpwd"
                                        id="confirmpwd" class="form-control" placeholder="Confirm Password">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-sm-12 mt-20">
                                <div class="form-group">
                                    <button type="submit" id="contact_form_submit" name="signup_submit"
                                        class="btn btn-small btn-outline-maincolor"><span>Signup</span>
                                    </button>
                                </div>
                            </div>
                        </div>
