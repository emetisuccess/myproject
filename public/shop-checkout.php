                                ...
                                <div class="woocommerce-billing-fields__field-wrapper">
                                    <p class="form-row form-row-first validate-required woocommerce-invalid woocommerce-invalid-required-field"
                                        ...
                                        <input type="text" class="input-text form-control" name="billing_first_name"
                                            id="billing_first_name" placeholder="First name" value=""
                                    ...
                                    <p class="form-row form-row-last validate-required" id="billing_last_name_field"
                                        ...
                                        <input type="text" class="input-text form-control" name="billing_last_name"
                                            id="billing_last_name" placeholder="Last name" value=""
                                            autocomplete="family-name">
                                    </p>
                                    <p class="form-row form-row-wide" id="billing_company_field" data-priority="30">
                                        <label for="billing_company" class="">Company name</label>
                                        <input type="text" class="input-text form-control" name="billing_company"
                                            id="billing_company" placeholder="Company name" value=""
                                    ...
                                    <p class="form-row form-row-wide address-field validate-required"
                                        ...
                                        <input type="text" class="input-text form-control" name="billing_city"
                                            id="billing_city" placeholder="Town / City" value=""
                                    ...
                                    <p class="form-row form-row-wide address-field validate-state validate-required"
                                        ...
                                        <label for="billing_state" class="">State / County <abbr class="required"
                                                title="required">*</abbr>
                                        </label>
                                        <input type="text" class="input-text form-control" value=""
                                            placeholder="tate / County " name="billing_state" id="billing_state"
                                    ...
                                    <p class="form-row form-row-wide address-field validate-postcode validate-required"
                                        ...
                                        <input type="text" class="input-text form-control" name="billing_postcode"
                                            id="billing_postcode" placeholder="Postcode / ZIP" value=""
                                    ...
                                    <p class="form-row form-row-first validate-required validate-phone"
                                        ...
                                        <input type="tel" class="input-text form-control" name="billing_phone"
                                            id="billing_phone" placeholder="billing phone" value="" autocomplete="tel">
                                    </p>
                                    <p class="form-row form-row-last validate-required validate-email"
                                        ...
                                        <input type="email" class="input-text form-control" name="billing_email"
                                            id="billing_email" placeholder="" value="admin@test.com"
                                            autocomplete="email">
                                    </p>
                                </div>
                        ...
                        <div id="payment" class="woocommerce-checkout-payment">
                            <ul class="wc_payment_methods payment_methods methods">
                                ...
                                <li class="wc_payment_method payment_method_cod">
                                    ...
                                    <label for="payment_method_cod">
                                        Make payment online (+ &#8358;3000) </label>
                            ...
                            <div class="form-row place-order">
                                ...
                                <button type="submit" class="btn btn-outline-maincolor small-button"
                                    name="woocommerce_checkout_place_order">Place order</button>
                            </div>
                        </div>
                    </div>
                </form>
