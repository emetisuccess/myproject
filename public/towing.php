...
<section class="page_title ds s-pt-105 s-pb-50 s-pt-lg-115 s-pb-lg-60">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12">
                <h1 class="bold text-center text-lg-left">Towing Services</h1>
                <ol class="breadcrumb">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="d-flex flex-column contact-icon">
                    ...
                    <div class=" text-center mt-3 p-2">
                        ...
                        <p>
                            From our website, you may select the service type, specify the location, and make payments.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="d-flex flex-column  contact-icon">
                    ...
                    <div class=" text-center mt-3 p-2">
                        ...
                        <p>
                            Driver either tows you to the desired location or takes you back on the road.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">You will undoubtedly need professionals to help you arrange a towing truck
                            ...
                            always prepared to help you in an emergency situation involving a bus or coach recovery.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Towing a car can be difficult to attempt on your own if you do not have the
                            ...
                            Car Removal. Vehicar provides a fast, affordable, friendly, and reliable car towing service.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text"> At Vehicar we provide you with roadside assistance, and can also Tow Your
                            ...
                            quick, and responsive to our towing services. </p>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text mx-auto">Motorcycle mishaps can occur anytime. If something goes wrong with
                            ...
                            to have it towed with our Motorcycle Tow Service at Vehicar. </p>
                    </div>
                </div>
            </div>
        </div>
...
<section class="s-pt-60 s-pb-15 s-py-lg-90 ls ms pb-2">
    <div class="container">
        ...
        <div class="text-center mt-3 p-2">
            <p>
                Vehicar connects you to the closest towing service or tow truck company near you. Tow trucks are
                available 24/7 to tow your car.
            </p>
