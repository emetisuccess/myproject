                        ...
                        <table class="table table-hover table-bordered ">
                            ...
                            <tbody>
                                ...
                                while ($rows = $select_cat->fetch_assoc()) {
                                    ...
                                    echo "<td>
                                    <a href='edit_category.php?edit_cat={$cat_id}' class='text-info p-2'><i class='fa fa-edit'></i></a>
                                    <a href='delete_category.php?del_cat={$cat_id}' class='text-danger p-2'><i class='fa fa-trash'></i></a>
                                    </td>";
                                    echo "</tr>";
                                }
                                ?>
