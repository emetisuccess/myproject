<section class="s-pt-55 s-pb-0 s-pt-md-50 s-pt-lg-140 s-pb-lg-145 ls ms
					text-center steps-section" id="step">
    <div class="container">
            ...
            <div class="col-12 col-lg-3">
                <div class="steps">
                    ...
                    <div class="step-content">
                        ...
                        <p class="color-dark">Help extend the life of your major business
                            investment</p>
                    </div>
                </div>
            </div>
            <div class="col-12 col-lg-3">
                <div class="steps feature-step">
                    ...
                    <div class="step-content">
                        ...
                        <p class="color-dark">Regarding our technicians, it takes 30 years of
                            ongoing training</p>
                    </div>
                </div>
            </div>
            <div class="col-12 col-lg-3">
                <div class="steps">
                    ...
                    <div class="step-content">
                        ...
                        <p class="color-dark">Convoy Auto Repair provides expert repairs,
                            service</p>
                    </div>
                </div>
