<footer class="page_footer text-center text-md-left ds ms s-pt-65
					s-pt-lg-125 s-pb-lg-35 c-gutter-40 main-footer">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 col-lg-3 animate" data-animation="fadeInUp">
                ...
                <div class="widget widget_icons_list">
                    <a href="index.php" class="logo">
                        ...
                        <span class="logo-text fw-500">Vehicar<span class="fw-200">Car</span></span>
                    </a>
                    <div class="media side-icon-box">
                        <div class="icon-styled color-main">
                            <i class="fa fa-map-marker"></i>
                        </div>
                        <p class="media-body color-grey">2688 Simpson Avenue Harrisburg, PA
                            17109 </p>
                    </div>
                    <div class="media side-icon-box">
                        <div class="icon-styled color-main">
                        ...
                        <p class="media-body color-grey">+234 234 56 78</p>
                    </div>
                    <div class="media side-icon-box">
                        <div class="icon-styled color-main">
                        ...
                        <p class="media-body color-grey">
                            <a href="mailto:">info@vehicar.com</a>
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <ul>
                        <li class="row">
                            ...
                            <div class="col-md-9 col-5">
                                <span class="color-darkgrey">9.<sup>00</sup>am -
                                    8.<sup>00</sup>pm</span>
                            </div>
                        </li>
                        <li class="row">
                            <div class="color-grey col-3">
